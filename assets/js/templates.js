...
<script>
  ...
  roleAllow(id) {
    ...
    const map = {
      ...
      front_desk: staff, document_builder: staff, fleet_tracking: staff, facility_booking: staff, rubrics: staff, substitutions: staff, book_request: staff + ' ' + learner,

      // Shared pages, still data-scoped by RLS and page logic
      attendance: staff + ' ' + parent + ' ' + learner, results: staff + ' ' + parent + ' ' + learner, 'report-cards': staff + ' ' + parent + ' ' + learner,
      'student-profile': staff + ' ' + parent + ' ' + learner, fees: admin + ' ' + parent, payments_online: admin + ' ' + parent,
      timetable: allUsers, assignments: staff + ' ' + parent + ' ' + learner, digital_library: staff + ' ' + parent + ' ' + learner,
      lms: staff + ' ' + parent + ' ' + learner, gamification: staff + ' ' + parent + ' ' + learner, conduct: staff + ' ' + parent,
      behaviour: staff + ' ' + parent + ' ' + learner, support_plans: staff + ' ' + parent + ' ' + learner, counselling: staff + ' ' + parent + ' ' + learner,
      health: staff + ' ' + parent, transport: staff + ' ' + parent + ' ' + learner, hostel: staff + ' ' + parent + ' ' + learner,
      library: staff, menu: staff + ' ' + parent + ' ' + learner, cafeteria: staff + ' ' + parent + ' ' + learner,
      parent_meeting: staff + ' ' + parent, complaints: staff + ' ' + parent + ' ' + learner, idcards: staff + ' ' + parent + ' ' + learner,
      certificates: staff + ' ' + learner, transcripts: staff + ' ' + parent + ' ' + learner, transfer_cert: staff, checkin: staff + ' ' + learner,
      diary: staff + ' ' + parent + ' ' + learner, surveys: staff + ' ' + parent + ' ' + learner, career_counseling: staff + ' ' + learner,
  ...
  allModules(config) {
    ...
    const dedicatedPages = ['student-profile','cbt-exam','academic-records','verify-certificate','teacher-overview','feature-guide','about','contact','apply','notifications'];
  ...
  dashboard(config) {
    ...
    return T.shell(config, 'Dashboard', `
      ...
      <section data-dash-role="super_admin admin" style="display:none">
      ...
      <section data-dash-role="staff" style="display:none">
